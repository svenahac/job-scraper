...
describe('parseGuestCards', () => {
  ...
  // Asserts first-seen-wins, NOT uniqueness. Uniqueness is structurally
  // guaranteed by the Map, so asserting it can never fail; which occurrence
  // survives is what the dedup guard actually controls.
